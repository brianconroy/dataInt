...
# 3 models to compare
#   pooled vs multispecies vs separate analysis
# 3 different scenarios
#   low, high, low & different Ws
# compare on basis of 
...
dst <- "/Users/brianconroy/Documents/research/project2/simulation_1_comparison/"
...
# rmse table
  # perturbation | w | model | lodds rmse
...
for (p in perturbs){
  for (m in models){
    ...
    rmses1[[counter]] <- list(perturbation=p, model=m, w="same", rmse=rmse)
    counter <- counter + 1
  }
}
