...
par(mfrow=c(1,3))
plot(w_output$samples.beta[,1], type='l'); abline(h=beta.loc[1], col=2)
plot(w_output$samples.beta[,2], type='l'); abline(h=beta.loc[2], col=2)
plot(w_output$samples.beta[,3], type='l'); abline(h=beta.loc[3], col=2)
par(mfrow=c(1,1))
