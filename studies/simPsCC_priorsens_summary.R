...
# to make
# figure of traceplots for target param over different priors
# table of param estimates for target param over different priors
# plot of biases of other params
