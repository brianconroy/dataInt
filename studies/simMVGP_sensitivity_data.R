...
Theta1 <- 2
Theta2 <- 4
Sigma1 <- Exponential(D, range=Theta1, phi=1)
Sigma2 <- Exponential(D, range=Theta2, phi=1)
# set.seed(40)
w1 <- mvrnorm(n=1, mu=rep(0, length(cells.all)), Sigma1)
w2 <- mvrnorm(n=1, mu=rep(0, length(cells.all)), Sigma2)
A <- matrix(c(1, 1, -1, -0.5), nrow=2)
...
save_output(data, "simMVGP_sensitivity_data_0.json")
...
save_output(params, "simMVGP_sensitivity_params_0.json")


############################
#### medium difference in range
#### phis = 1
############################
...
save_output(data, "simMVGP_sensitivity_data_01.json")
...
save_output(params, "simMVGP_sensitivity_params_01.json")


############################
#### large difference in range
#### phis = 1
############################
...
save_output(data, "simMVGP_sensitivity_data_02.json")
...
save_output(params, "simMVGP_sensitivity_params_02.json")
