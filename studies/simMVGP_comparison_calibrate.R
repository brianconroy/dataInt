...
for (sw in 25:50){
  ...
  l1 <- c(l1, sum(locs1$status))
  l2 <- c(l2, sum(locs2$status))
...
Alpha.case2 <- 1
Alpha.ctrl2 <- -1
beta.case1 <- c(2.5, 0.75, -0.50)
beta.ctrl1 <- c(2.5, 0.5, 0.5)
beta.case2 <- c(2, 0.8, -0.5)
beta.ctrl2 <- c(2, 0.15, 0.5)
...
save_output(data, "simMVGP_comparison_data_new1.json")
...
save_output(params, "simMVGP_comparison_params_new1.json")
...
save_output(data, "simMVGP_comparison_data_medium2.json")
...
save_output(params, "simMVGP_comparison_params_medium2.json")
