...
output <- prefSampleGpCC(data, n.sample, burnin,
                         ...
                         prior_phi=c(9.33, 100), prior_theta=c(2.45, 2.45))
...
write.table(lodds.true, paste(dir, 'lodds_true_none.txt', sep=''), row.names=F, col.names=F)
write.table(lodds.ps, paste(dir,'lodds_ps_none.txt', sep=''), row.names=F, col.names=F)
write.table(lodds.sp, paste(dir,'lodds_sp_none.txt', sep=''), row.names=F, col.names=F)
write.table(lodds.r, paste(dir,'lodds_r_none.txt', sep=''), row.names=F, col.names=F)
